...
<template>
    <TheNavbar />
    <div id="bg-wrap" class="fixed inset-0 overflow-hidden bg-black">
        <svg viewBox="0 0 100 100" class="bg-white max-h-screen w-screen" preserveAspectRatio="xMidYMid slice">
            ...
            <rect x="33.744%" y="1.18473%" width="100%" height="100%" fill="url(#Gradient1)"
            ...
            <rect x="-12.17916%" y="35.4267%" width="100%" height="100%" fill="url(#Gradient2)"
            ...
            <rect x="92.00483%" y="14.5733%" width="100%" height="100%" fill="url(#Gradient3)"
